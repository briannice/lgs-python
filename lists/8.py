# A professional translator is asked to translate the complete first volume of
# Harry Potter from English. He has two options for the salary. Either he gets
# 2 cents for each character he translates, or he gets 12 cents per word. As a 
# sample, he got the first page to translate. Based on this first page, which 
# option should he choose to get the most money?
